...
class TestBasicFieldExtraction:
    ...
    def test_extract_single_field_tab_delimited(self, sample_tab_file):
        ...
        tool = CutTool(fields="2", delimiter='\t', input_content=sample_tab_file)
    ...
    def test_extract_first_field_tab_delimited(self, sample_tab_file):
        ...
        tool = CutTool(fields="1", delimiter='\t', input_content=sample_tab_file)
        result = tool.get_result()
    ...
    def test_extract_last_field_tab_delimited(self, sample_tab_file):
        ...
        tool = CutTool(fields="3", delimiter='\t', input_content=sample_tab_file)
        result = tool.get_result()
    ...
    def test_extract_multiple_fields_in_order(self, sample_tab_file):
        ...
        tool = CutTool(fields="1,3", delimiter='\t', input_content=sample_tab_file)
        result = tool.get_result()
    ...
    def test_extract_multiple_fields_unordered(self, sample_tab_file):
        ...
        tool = CutTool(fields="3,1", delimiter='\t', input_content=sample_tab_file)
        result = tool.get_result()
...
class TestDelimiterHandling:
    ...
    def test_comma_delimiter(self, sample_comma_file):
        ...
        tool = CutTool(fields="2", delimiter=',', input_content=sample_comma_file)
        result = tool.get_result()
    ...
    def test_pipe_delimiter(self, sample_pipe_file):
        ...
        tool = CutTool(fields="2", delimiter='|', input_content=sample_pipe_file)
        result = tool.get_result()
...
class TestEdgeCases:
    ...
    def test_empty_file(self, empty_file):
        ...
        tool = CutTool(fields="1", delimiter='\t', input_content=empty_file)
        result = tool.get_result()
    ...
    def test_single_line_file(self, single_line_file):
        ...
        tool = CutTool(fields="2", delimiter='\t', input_content=single_line_file)
        result = tool.get_result()
    ...
    def test_field_out_of_bounds(self, sample_tab_file):
        ...
        tool = CutTool(fields="5", delimiter='\t', input_content=sample_tab_file)
        result = tool.get_result()
    ...
    def test_missing_field_in_some_lines(self, with_empty_fields_file):
        ...
        tool = CutTool(fields="2", delimiter='\t', input_content=with_empty_fields_file)
        result = tool.get_result()
...
class TestOutputFormatting:
    ...
    def test_field_order_preserved(self, sample_tab_file):
        ...
        tool = CutTool(fields="3,1,2", delimiter='\t', input_content=sample_tab_file)
        result = tool.get_result()
    ...
    def test_output_delimiter_matches_input(self, sample_comma_file):
        ...
        tool = CutTool(fields="1,2", delimiter=',', input_content=sample_comma_file)
        result = tool.get_result()
